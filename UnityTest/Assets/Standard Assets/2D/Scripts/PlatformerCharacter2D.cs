...
namespace UnityStandardAssets._2D
{
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        public void RunAndJumpRight(int jumpMagnitude)
        {
            m_JumpForce = jumpMagnitude;
            Move(0.8f, false, true);
            m_JumpForce = 500f;
        }

        public void Run(bool crouch, bool jump){
            if (m_FacingRight)
            {
               for (int i = 0; i < 10; i++)
                {
