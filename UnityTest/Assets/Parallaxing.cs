...
public class Parallaxing : MonoBehaviour {
    ...
    public Transform[] backgrounds; //Array of all the back and foregrounds to be parrallaxed
    private float[] parallaxScales; //The proportion of the camera's movement to move background by
